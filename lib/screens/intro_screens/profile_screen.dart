...
class _SetupProfileState extends State<SetupProfile> {
  ...
  // ValueNotifier<String> imge = ValueNotifier('./assets/images/user.jpg');
  dynamic image;
                            ...
                            Padding(
                              ...
                              child: GestureDetector(
                                ...
                                : CircleAvatar(
                                 ...
                                 child: CircleAvatar(
                                   backgroundImage: ExactAssetImage('./assets/images/log.jpg'),
                                child :  ( _data.profilePhoto!=null) ? Image(image:FileImage(
                                          File(_data.profilePhoto
                                              .toString()))): Text(''),
